...
- 1 PC/laptop com acesso à Internet por grupo para aceder à plataforma Petlja e outros recursos externos necessários durante a atividade
...
O seu trabalho será avaliado com base no **progresso do grupo em cada sessão**, com atenção especial à organização do trabalho em equipa e à eficácia da colaboração, bem como ao produto final produzido, **um tutorial de desmontagem e montagem**.

No final deste curso, cada aluno deverá ser capaz de:

- Aplicar os procedimentos corretos para montar e desmontar um computador.
- Demonstrar práticas seguras ao manusear componentes de hardware durante as tarefas de montagem e desmontagem.
- Identificar e registar as especificações técnicas básicas (ex: marca, modelo, capacidade) dos principais componentes do computador.
...
O seu trabalho será avaliado de acordo com o seguinte **rubrica**:

### Rubrica: Escala de Avaliação

- 1 - Não seguido de nenhuma forma
- 2 — Não seguido na maioria das vezes
- 3 — Seguido na maioria das vezes
- 4 — Seguido totalmente 

| Critérios                                                                | 1 | 2 | 3 | 4 |
|--------------------------------------------------------------------------|---|---|---|---|
| Aplica procedimentos corretos de montagem/desmontagem                    | 1 | 2 | 3 | 4 |
| Demonstra práticas seguras de manuseio de hardware                       | 1 | 2 | 3 | 4 |
| Identifica e regista especificações técnicas                             | 1 | 2 | 3 | 4 |
| Produz documentação técnica clara e precisa                              | 1 | 2 | 3 | 4 |
| **Habilidades de Colaboração**                                           |   |   |   |   |
| 1. Somos todos iguais e nos respeitamo-nos.                              | 1 | 2 | 3 | 4 |
...
| 5. Procuramos envolver todos nas decisões.                               | 1 | 2 | 3 | 4 |
...
| 8. Usamos sabiamente o nosso tempo para trabalhar na tarefa.             | 1 | 2 | 3 | 4 |
| 9. Monitorizamos o nosso progresso e planejamos o próximo passo.         | 1 | 2 | 3 | 4 |
